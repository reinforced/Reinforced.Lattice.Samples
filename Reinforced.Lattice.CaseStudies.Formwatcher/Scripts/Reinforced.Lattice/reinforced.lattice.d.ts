...
declare module Reinforced.Lattice {
    ...
    interface IClientFilter {
        /**
         * Method being called on all client filters before performing core filtering.
         * Used to pre-calculate values being filtered
         *
         * @param query Filtering query
         * @param context Filtering context storing precomputed values
         * @returns {}
         */
...
declare module Reinforced.Lattice.Services {
    ...
    class ConfirmationWindowViewModel implements Reinforced.Lattice.Editing.IEditHandler {
        ...
        /**
         * Confirmation window visual states
         */
        ...
        Subject: any;
        /**
         * Set of objects selected in table
         */
        Selection: any[];
        /**
