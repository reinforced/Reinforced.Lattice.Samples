...
{
    public class MultiSelectFilterController : Controller
    {
        ...
        {
            var conf = new Configurator<Contract, ContractRow>().ConfigureMultiSelectFilters();
        ...
        public MultiSelectFilterController()
        {
